...
export const init = () => {
  const promiseDB = new Promise((resolve, reject) => {
    db.transaction(
            function (tx) {
                tx.executeSql("CREATE TABLE IF NOT EXISTS user (userID INTEGER PRIMARY KEY NOT NULL, username TEXT NOT NULL, firstName TEXT NOT NULL, lastName TEXT NOT NULL, email TEXT NOT NULL, password TEXT NOT NULL, createdOn INTEGER)");
